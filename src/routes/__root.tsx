...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BookedMoves — Meta & TikTok Ads for Moving Companies" },
      {
        name: "description",
        content:
          "Ad campaigns and 2-minute follow-up that book more moves. 30+ qualified leads in 30 days, guaranteed.",
      },
